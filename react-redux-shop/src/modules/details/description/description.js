...
class Description extends React.PureComponent {
  ...
  toggleCompare = () => {
    this.setState(({ isCompare }) => {
      ...
      this.state.isCompare
        ? this.addCompare(this.props.product)
        : this.deleteCompare(this.props.product.id);
    });
  }
  ...
  componentDidMount() {
    ...
    this.setState({ isCompare: compare.includes(this.props.product.id) });
  }
      ...
      <>
        <div className="flex">
          ...
          <div className="col-6">
            ...
            <button className="button-primary phone-details__button">Купить</button>
