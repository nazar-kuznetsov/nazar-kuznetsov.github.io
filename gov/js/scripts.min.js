 ...
 =======================================================================================*/
	function cropStr(node, length) {
		...
		elements.forEach(function (article) {
			article.textContent = article.textContent.trim().substring(0, length) + '...';
		});
	}
 ...
 это функция нужна для того что бы не было конфикта */
	...
	function toggleEventDropDown() {
		if (window.innerWidth <= 1170) {
			nav.classList.add('on-click');
			nav.classList.remove('on-hover');
		} else {
			nav.classList.remove('on-click');
			nav.classList.add('on-hover');
		}
	}
...
$(function () {
	...
	/* выпадающие меню 3 уровня (DESKTOP)
 ===============================================================================================*/
	$('.drop-menu__inner .drop-menu__inner').hide();
	$('body').on('click', '#nav.on-hover .drop-menu__inner .drop-menu__link-title', function () {
		var parent = $(this).parent();
		parent.children('.drop-menu__inner').slideToggle();
