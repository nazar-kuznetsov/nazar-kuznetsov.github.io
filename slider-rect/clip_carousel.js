...
var circleItem = document.querySelectorAll('#circle-list li');
        ...
        */
        ...
        value: function go_to(direction) {
            ...
            circleItem.forEach(function (element) {
                return element.classList.remove('circle-active');
            });
            circleItem[self.next_index].classList.add('circle-active');
